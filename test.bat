...
echo Lookup result for phone number %phone%:
echo Simulated phone number lookup: Example User, (123) 456-7890, Example City
pause
goto modmenu
...
echo Lookup result for name %name%:
echo Simulated name lookup: Example Email: example@domain.com, Example Phone: (123) 456-7890
pause
goto modmenu
...
echo Lookup result for email %email%:
echo Simulated email lookup: Example User, Example Organization, Valid
pause
goto modmenu
